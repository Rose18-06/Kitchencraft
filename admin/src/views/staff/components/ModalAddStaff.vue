    ...
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content ">
        ...
        <div class="modal-footer">
          ...
          <button type="button" class="btn btn-primary" @click="registerStaff()">Register Staff</button>
        </div>
      </div>
    </div>
  </div>
...
<script lang="ts">
  ...
  export default defineComponent({
    ...
    methods: {
      ...
      async registerStaff() {
        await axios.get( variable()['api_main'] + "users_system/create?" + $.param(this.staff)).then( async (response) => {
